				...
				<div class="cart">
					...
					<div class="menu-main">
						...
						<ul class="dc_css3_menu">
							...
							<li class="active"><a href="adminaddcar.php">Car++</a></li>
					...
					<div class="col-md-6">
						...
						<form class="text-center" action="adminaddcar.php" method="post">
							...
							<div><br />
								...
								<input type="number" class="form-control transparent-input" placeholder="chasis"
									name="chasis">
							</div>
							...
							<div><br />
								<label>Color</label>
								<input type="text" class="form-control transparent-input" size="50" placeholder="color"
									name="color">
							</div>


							<div><br />
								<button type="submit" name="add" class="btn btn-warning" value="add"
									onClick='alert("Car added to the Database")'>Add car</button>
							</div>
						</form>
					</div>
				...
				<div class="col_1_of_5 span_1_of_5">
					<div class="footer-grid twitts">
						...
						<ul class="follow_icon">
							<li><a href="https://www.google.com" style="opacity: 1;"><img src="images/follow_icon.png"
										alt=""></a></li>
...
$db = mysqli_connect("localhost", "root", "admin", "car_showroom");
