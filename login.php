					...
					<div class="col-md-6">
						...
						<form class="text-center" action="login.php" method="post">
							<div><br />
								...
								<input type="text" id="useremail" class="form-control transparent-input" size="50"
									placeholder="YOUR EMAIL" name="useremail" required>
							</div>

							<div><br />
								<label for="pass">PASSWORD</label>
								<input type="password" id="pass" class="form-control transparent-input" size="50"
									placeholder="PASSWORD PLEASE" name="pass" required>
							</div>
							<div><br />
								<button type="submit" class="btn btn-warning" value="login" name="login">Sign
						...
						<script>
							function validateForm() {
								...
								// Check if email field is a valid email format
								...
								// Check if password field is at least 8 characters long
